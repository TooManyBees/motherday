(function($) {
    ...
    window.initMothersDayCard = function() {
        ...
        var textAreaLength1 = 50,
            textAreaLength2 = 100,
            textAreaLength3 = 160;
        textArea.onkeydown = function(e) {
            if (textArea.textLength > textAreaLength3) {
                textArea.classList.remove("smaller-script");
                textArea.classList.add("smallest-script");
            } else if (textArea.textLength > textAreaLength2) {
                textArea.classList.remove("small-script");
                textArea.classList.add("smaller-script");
            } else if (textArea.textLength > textAreaLength1) {
                textArea.classList.remove("smaller-script");
                textArea.classList.add("small-script");
            } else {
                textArea.classList.remove("small-script");
                textArea.classList.remove("smaller-script");
            }
